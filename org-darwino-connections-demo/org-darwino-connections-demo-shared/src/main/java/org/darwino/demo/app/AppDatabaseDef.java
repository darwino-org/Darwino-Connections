...
public class AppDatabaseDef extends DatabaseFactoryImpl {
	...
	public static final String DATABASE_NAME	= "conndemo";
	...
	public static String[] getInstances() {
		...
		String inst = Platform.getProperty("conndemo.instances");
	...
	public _Database loadDatabase(String databaseName) throws JsonException {
		...
		_Database db = new _Database(DATABASE_NAME, "IBM Connections Demo", DATABASE_VERSION);
